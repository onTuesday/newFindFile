   ...
   public class Class_Client
    {
        ...
        public void resultTest1()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder2\\qwer.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder2\\solaraLovesFootball.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder2\\wer.txt")), true);
            Result.result.Clear(); 
        }
        ...
        public void resultTest2()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture1.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture12.jpg")), true );
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture48.jpg")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest3()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\pict229.jpeg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture1.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture12.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture48.jpg")), true);
        ...
        public void resultTest5()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\22ofnovember.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\decemberthe25th.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\octoberhalloween31.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\september20.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\septemberthe1.jpg")), true);
        ...
        public void resultTest6()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picasso.txt")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest7()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\JfK.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\okok.jpg")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\september20.jpg")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest8()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\agatachas0.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\danse_agatha.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Fury_King.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\King_Bleid.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\kolorado_king.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\killed.png")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\ugly.png")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest9()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Hello.txt")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest13()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\pic_description.txt")), true);
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder3\\picture.jpg")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest14()
        {
            ...
            Assert.AreEqual(Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\kennedy.jpg")), true);
            Result.result.Clear();
        }
        ...
        public void resultTest15()
        {
            ...
            Assert.AreEqual(true, Result.result.Contains(System.IO.Path.GetFullPath("..\\..\\..\\Testing\\TestFolder4\\Photos\\1.jpg")));
            Result.result.Clear();
        }
    }
}
